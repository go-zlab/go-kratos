module github.com/go-zlab/go-kratos/transport/activemq
...
replace (
	...
	github.com/go-zlab/go-kratos/broker/stomp => ../../broker/stomp
...
require (
	...
	github.com/go-zlab/go-kratos/broker/stomp v1.0.0
