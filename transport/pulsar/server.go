...
import (
	...
	"github.com/go-zlab/go-kratos/broker/pulsar"

	"github.com/go-zlab/go-kratos/transport"
	"github.com/go-zlab/go-kratos/transport/keepalive"
)
...
func (s *Server) init(opts ...ServerOption) {
	...
	s.keepaliveServer = keepalive.NewServer(
		keepalive.WithServiceKind(KindPulsar),
	)

	s.Broker = pulsar.NewBroker(s.brokerOpts...)
}

func (s *Server) Name() string {
	return string(KindPulsar)
}
