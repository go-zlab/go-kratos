module github.com/go-zlab/go-kratos/transport/pulsar

go 1.25.0

replace (
	github.com/go-zlab/go-kratos/broker => ../../broker
	github.com/go-zlab/go-kratos/broker/pulsar => ../../broker/pulsar
...
require (
	...
	github.com/go-zlab/go-kratos/broker/pulsar v1.0.0
