module github.com/go-zlab/go-kratos/transport/rocketmq
...
replace (
	...
	github.com/go-zlab/go-kratos/broker/rocketmq => ../../broker/rocketmq
...
require (
	...
	github.com/go-zlab/go-kratos/broker/rocketmq v1.0.0
