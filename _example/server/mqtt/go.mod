module github.com/go-zlab/go-kratos/_example/server/mqtt

go 1.25.0

replace (
	github.com/go-zlab/go-kratos/broker => ../../../broker
	github.com/go-zlab/go-kratos/broker/mqtt => ../../../broker/mqtt
	github.com/go-zlab/go-kratos/testing => ../../../testing
	github.com/go-zlab/go-kratos/tracing => ../../../tracing
	github.com/go-zlab/go-kratos/transport/mqtt => ../../../transport/mqtt
)
...
require (
	...
	github.com/go-zlab/go-kratos/transport/mqtt v1.3.2
)
...
require (
	...
	github.com/go-zlab/go-kratos/broker/mqtt v1.3.5 // indirect
