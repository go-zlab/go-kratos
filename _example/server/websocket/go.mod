module github.com/go-zlab/go-kratos/_example/server/websocket
...
replace (
	...
	github.com/go-zlab/go-kratos/transport/websocket => ../../../transport/websocket
)

require (
	github.com/go-kratos/kratos/v2 v2.9.2
	github.com/go-zlab/go-kratos/transport/websocket v1.0.0
)
