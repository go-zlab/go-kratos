module github.com/go-zlab/go-kratos/_example/broker/redis
...
replace (
	...
	github.com/go-zlab/go-kratos/broker/redis => ../../../broker/redis
...
require (
	...
	github.com/go-zlab/go-kratos/broker/redis v1.0.0
